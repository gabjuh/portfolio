  ...
  return (
    <div className="bg-white" id="certificates-box">
      <div className="px-lg-5">
        <h1 className="text-center mt-3 mb-5" >{data.containerTitle}</h1>
              ...
              <div className="col-lg-6" key={certificate.id}>
                <div className="d-flex my-4">
                  ...
                  <div>
                    ...
                    <a className="btn btn-info text-white mt-1" href={certificate.file} target="_blank" download>Download Certificate</a>
                  </div>
                </div>
              </div>
            )
